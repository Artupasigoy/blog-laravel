...
<body class="hold-transition sidebar-mini layout-fixed"> <!-- sidebar-collapse -->
    <div class="wrapper">
        ...
        {{-- <div class="preloader flex-column justify-content-center align-items-center">
            <span class="fa-2x brand-text font-weight-bold px-2">{{ config('app.sitesettings')::first()->site_title
                }}</span>
        </div> --}}
        ...
        {{-- Konten Utama (Disuntikkan dari view lain) --}}
        @yield("content")
    ...
    <script
        src="{{ asset("assets/dashboard/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js") }}"></script>
