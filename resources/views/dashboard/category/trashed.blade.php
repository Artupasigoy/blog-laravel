                        ...
                        <div class="card">
                            @if ($categories->count() > 0)
                                <div class="card-header">
                                    ...
                                    <form action="{{ route('dashboard.categories.empty_trash') }}" method="POST"
                                            ...
                                            @forelse ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span
                                                            class="badge bg-{{ $category->status ? "success" : "warning" }}">{{ $category->status ? "Active" : "Inactive" }}</span>
                                                    </td>
                                                    <td class="text-center">
    ...
    <script>
        $('.deletebtn').on('click', function (e) {
            ...
            Swal.fire({
                ...
                type: 'warning',
                icon: 'warning',
                text: 'All posts of this category will be permanently deleted!',
        ...
        $('#empty-trash-btn').on('click', function (e) {
            ...
            Swal.fire({
                title: 'Empty Trash?',
                icon: 'warning',
                text: "All trashed categories and their posts will be permanently deleted!",
                showCancelButton: true,
