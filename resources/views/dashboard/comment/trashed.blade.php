                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.comments.index') }}">All Comments</a>
                            </li>
                        ...
                        <div class="card">
                            @if ($comments->count() > 0)
                                <div class="card-header">
                                    ...
                                    <form action="{{ route('dashboard.comments.empty_trash') }}" method="POST"
    ...
    <script>
        ...
        $('#empty-trash-btn').on('click', function (e) {
            ...
            Swal.fire({
                title: 'Empty Trash?',
                icon: 'warning',
                text: "All trashed comments will be permanently deleted!",
                showCancelButton: true,
