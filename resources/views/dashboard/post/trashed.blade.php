                        ...
                        <div class="card">
                            @if ($posts->count() > 0)
                                <div class="card-header">
                                    ...
                                    <form action="{{ route('dashboard.posts.empty_trash') }}" method="POST"
                                            ...
                                            @forelse ($posts as $post)
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span
                                                            class="badge bg-{{ $post->status ? "success" : "danger" }}">{{ $post->status ? "Published" : "Draft" }}</span>
                                                    </td>
                                                    <td class="text-center"><span
                                                            class="badge bg-{{ $post->is_featured ? "success" : "danger" }}">{{ $post->is_featured ? "Yes" : "No" }}</span>
                                                    </td>
                                                    <td class="text-center"><span
                                                            class="badge bg-{{ $post->enable_comment ? "success" : "danger" }}">{{ $post->enable_comment ? "Enable" : "Disable" }}</span>
                                                    </td>
    ...
    <script>
        ...
        $('#empty-trash-btn').on('click', function (e) {
            ...
            Swal.fire({
                title: 'Empty Trash?',
                icon: 'warning',
                text: "All trashed posts will be permanently deleted!",
                showCancelButton: true,
